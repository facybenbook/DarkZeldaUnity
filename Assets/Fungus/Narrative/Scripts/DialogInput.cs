...
namespace Fungus
{
	...
	public class DialogInput : MonoBehaviour
	{
		...
		public enum KeyPressMode
		{
            ...
            InteractButtonPressed      // Pressed Input button assigned in Unity
		}
		...
		public float nextClickDelay = 0.25f;
		...
		protected virtual void Update()
		{
			...
			case KeyPressMode.KeyPressed:
				...
				break;
            case KeyPressMode.InteractButtonPressed:
                if (Input.GetButtonDown("Interact") && GameObject.FindGameObjectWithTag("Textbox").activeInHierarchy == true)
                {
                    SetNextLineFlag();
                }
                break;
